...
exports.VSCodeCommander = void 0;
const vscode = __importStar(require("vscode"));
class VSCodeCommander {
    getWorkspaceUri() {
        ...
        try {
            switch (cmd.action) {
                ...
                case 'writeFile': {
                    ...
                    const confirmWrite = await vscode.window.showWarningMessage(`Allow ChatGPT to write to the file '${cmd.params.path}'?`, { modal: true, detail: `Content preview (first 100 chars):\n${contentString.substring(0, 100)}...` }, 'Yes', 'No');
                    if (confirmWrite !== 'Yes') {
                ...
                case 'executeTerminal': {
                    ...
                    const confirmTerminal = await vscode.window.showWarningMessage(`Allow ChatGPT to execute the following command in the terminal?\n\nCommand: ${cmd.params.command}`, { modal: true }, 'Yes', 'No');
                ...
                case 'getWorkspaceFiles': {
                    const maxFiles = vscode.workspace.getConfiguration('chatgpt-web').get('maxFiles', 100);
...
exports.VSCodeCommander = VSCodeCommander;
//# sourceMappingURL=VSCodeCommander.js.map